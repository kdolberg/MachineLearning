...
void ActFuncTest::sigmoid() {
	...
	TEST_RETURN_FUNC(LinearAlgebra::approx(sigm(0.5f),			0.6224593312018958f		),	==, true);
	TEST_RETURN_FUNC(LinearAlgebra::approx(sigm(-1.0f),			0.26894142136992605f	),	==, true);
	TEST_RETURN_FUNC(LinearAlgebra::approx(sigm.ddx(5.0f),		0.006648056670778641f	),	==, true);
	TEST_RETURN_FUNC(LinearAlgebra::approx(sigm.ddx(-7.0f),		0.000910221180119593f	),	==, true);
}
