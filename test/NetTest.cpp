...
// 	auto percent_error_result = percent_error(n.calculate_gradient(),NetTest::Numerical::numerical_gradient(n));
// 	PRINT_VAR(percent_error_result);
// 	PRINT_VAR(abs(max(percent_error_result)));
// 	PRINT_VAR(abs(min(percent_error_result)));
// }
